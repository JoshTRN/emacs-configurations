...
(custom-theme-set-faces
 ...
 '(match ((t (:weight bold :foreground "gray80" :background "SlateBlue4"))))
 ...
 `(org-block ((t (:foreground "white" :extend t :family "Fira Code" :background ,solaire-bg))))
 ...
 '(org-level-1 ((t (:foreground "#00FFBF" :weight bold :inherit variable-pitch))))
 '(org-level-10 ((t (:foreground "#00d364"))))
 '(org-level-2 ((t (:foreground "#AE81FF" :weight bold :inherit variable-pitch))))
 '(org-level-3 ((t (:foreground "#CDD581" :weight bold))))
 ...
 `(org-verbatim ((t (:foreground "#CDD581" :background ,solaire-bg :extend t :inherit 'fixed-pitch :family "Fira Code" :box (:line-width 1 :color "#051b29")))))
 ...
 '(region ((t (:inherit highlight :extend t :background "#2f507a" :foreground nil))))
 ...
 '(web-mode-html-tag-namespaced-face ((t (:foreground "deep sky blue"))))
 ...
 `(company-tooltip ((t (:background ,solaire-bg))))
 '(company-tooltip-selection ((t (:extend t :inherit highlight :foreground "LavenderBlush2"))))
