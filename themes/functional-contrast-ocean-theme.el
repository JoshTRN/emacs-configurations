...
(custom-theme-set-faces
 ...
 `(header-line ((t (:box (:line-width 1 :color "#64645E" :style unspecified) :foreground "#F8F8F0" :background ,solaire-bg :inherit (mode-line)))))
 ...
 `(mode-line ((t (:box (:line-width 1 :color "#64645E") :foreground "#F8F8F0" :background "#003c61" :inherit region))))
 ...
 `(mode-line-inactive ((t (:box (:line-width 1 :color "#64645E" :style unspecified) :foreground "DeepSkyBlue3" :background ,solaire-bg))))
 ...
 `(default ((t (:inherit nil :extend nil :stipple nil :background ,bg-color :foreground "slategray1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "CTDB" :family "Fira Code"))))
 )
