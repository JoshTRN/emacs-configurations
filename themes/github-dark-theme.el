...
(autothemer-deftheme
 github-dark "Github theme for Emacs"
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (keyword-color            "#e56b62" "#e56b62")
  (text-color             "#a2afbc" "#a2afbc")
  (background-color       "#0d1117" "#0d1117")
  (string-color         "#8dc2ee" "#8dc2ee")
  (number-color         "#5f9edc" "#5f9edc")
  (highlight-color       "#444c56" "#444c56")
  (oniViolet             "#cfbdfb" "#cfbdfb")
  (yellow-color          "#e48842" "#e48842"))
