...
(custom-theme-set-faces
 ...
 '(highlight-indentation-face ((t (:background "#001a14"))))
 ...
 '(line-number ((t (:inherit (shadow default) :foreground "#439987"))))
 '(line-number-current-line ((t (:inherit shadow :foreground "#9ff8cf"))))
 ...
 '(magit-diff-hunk-heading ((t (:inherit powerline-inactive2 :extend t))))
 ...
 '(spaceline-evil-visual ((t (:inherit 'mode-line :foreground "#3E3D31"))))
 ...
 '(spacemacs-visual-face ((t (:inherit 'mode-line :foreground "#000000" :background "dark slate blue"))))
