...
(custom-theme-set-faces
 ...
 '(org-superstar-item ((t (:foreground "#F92672"))))
 '(org-table ((t (:extend t :foreground "gray85" :background "#060013"))))

 '(default ((t (:inherit nil :extend nil :stipple nil :background "#0a001f" :foreground "gray85" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "CTDB" :family "Fira Code"))))
 )
