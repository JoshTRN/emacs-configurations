...
(custom-theme-set-faces
 ...
 '(fringe ((t (:background "#0a001f" :foreground "#F8F8F2"))))
 ...
 '(line-number-current-line ((t (:inherit line-number :foreground "light gray"))))
 ...
 '(mode-line ((t (:box (:line-width 1 :color "#64645E" :style unspecified) :foreground "#F8F8F0" :background "#000000"))))
 ...
 '(mode-line-inactive ((t (:box (:line-width 1 :color "#64645E" :style unspecified) :foreground "#75715E" :background "#000000"))))
 '(next-error ((t (:inherit (region)))))
 '(org-kbd ((t (:inherit custom-button))))
 '(powerline-active0 ((t (:inherit (mode-line)))))
 '(powerline-active1 ((t (:foreground "white" :background "grey17" :inherit (mode-line)))))
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#0a001f" :foreground "#26A69A" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "CTDB" :family "Fira Code"))))
 )
