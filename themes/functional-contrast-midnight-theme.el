...
(custom-theme-set-faces
 ...
 '(mode-line-inactive ((t (:box (:line-width 1 :color "#64645E" :style unspecified) :foreground "#75715E" :background "#060013"))))
 '(next-error ((t (:inherit (region)))))
 '(org-kbd ((t (:inherit custom-button))))
 '(powerline-active0 ((t (:inherit (mode-line)))))
 '(powerline-active1 ((t (:foreground "white" :background "#0a001f" :inherit (mode-line)))))
 ...
 '(org-level-1 ((t (:foreground "#CDD581" :height 1.4 :weight bold ))))
 '(org-level-2 ((t (:foreground "#00d364" :height 1.2 :weight demibold))))
 '(org-level-3 ((t (:foreground "#AE81FF" :height 1.1 :weight semibold))))
